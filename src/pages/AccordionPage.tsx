...
import { BasicAccordion } from "@/components/Accordion/Examples/Basic";
import { VariantAccordion } from "@/components/Accordion/Examples/Variant";
import { SizeAccordion } from "@/components/Accordion/Examples/Size";
import { ColorAccordion } from "@/components/Accordion/Examples/Color";
import { MultipleAccordion } from "@/components/Accordion/Examples/Multiple";
  ...
  const faqItems = [
    {
      ...
      title: "What is your return policy?",
      content:
        "We offer a 30-day return policy for all items in their original condition. Please contact our customer service team to initiate a return.",
    },
    {
      key: "faq-2",
      title: "How long does shipping take?",
      content:
        "Standard shipping takes 3-5 business days. Express shipping options are available for next-day delivery.",
    },
    {
      key: "faq-3",
      ...
      <div className="max-w-6xl mx-auto p-6 space-y-8">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            HeroUI-style accordion components with multiple variants, sizes,
            colors, and advanced features.
          </p>
        </div>
        ...
        <DemoCard title="Controlled Accordion">
          <div className="space-y-4">
            <div className="flex flex-wrap gap-2">
              ...
              <button
                onClick={() =>
                  setControlledKeys(["controlled-1", "controlled-2"])
                }
            ...
            >
              ...
              <AccordionItem itemKey="controlled-2" title="Controlled Item 2">
                <p>
                  State is managed by the parent component. Use the buttons
                  above to control expansion.
                </p>
              </AccordionItem>
            </Accordion>
        ...
        <DemoCard title="Items Configuration">
          <Accordion items={faqItems} variant="bordered" color="primary" />
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <Accordion showDivider={false} variant="flat">
                <AccordionItem
                  itemKey="no-divider-1"
                  title="No Dividers Item 1"
                >
                  Items without dividers between them.
                </AccordionItem>
                <AccordionItem
                  itemKey="no-divider-2"
                  title="No Dividers Item 2"
                >
          ...
          <div className="space-y-6">
            <div>
              <p className="text-sm text-gray-600 mb-4">
                Choose from 5 carefully crafted animation presets, each with
                unique timing and feel:
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xs text-gray-500 mb-3">
                  Professional feel with balanced spring physics
                </p>
                <Accordion
                ...
                >
                  <AccordionItem
                    itemKey="spring-1"
                    title="Spring Animation Preset"
                  >
                    <p>
                      Balanced spring physics (280 stiffness, 25 damping) for
                      professional interfaces. Perfect for most use cases.
                    </p>
                  </AccordionItem>
                  <AccordionItem itemKey="spring-2" title="Natural Movement">
                    <p>
                      Creates natural, responsive feeling interactions that
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-3">
                  Consistent and polished for elegant interfaces
                </p>
                <Accordion
                ...
                >
                  <AccordionItem
                    itemKey="smooth-1"
                    title="Smooth Animation Preset"
                  >
                    <p>
                      Medium spring settings (300 stiffness, 25 damping) create
                      consistent, polished animations.
                    </p>
                  </AccordionItem>
                  <AccordionItem itemKey="smooth-2" title="Elegant Interface">
                    <p>
                      Perfect for sophisticated, elegant user interfaces that
                      need refined motion.
                    </p>
                  </AccordionItem>
                </Accordion>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-3">
                  Playful and dynamic for interactive experiences
                </p>
                <Accordion
                ...
                >
                  <AccordionItem
                    itemKey="bouncy-1"
                    title="Bouncy Animation Preset"
                  >
                    <p>
                      High energy spring (500 stiffness, 15 damping) creates
                      playful, dynamic interactions.
                    </p>
                  </AccordionItem>
                  <AccordionItem itemKey="bouncy-2" title="Dynamic Experience">
                    <p>
                      Great for gaming interfaces, creative tools, or any app
                      that wants energetic feedback.
                    </p>
                  </AccordionItem>
                </Accordion>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-3">
                  Softer, more gentle animations for elegant experiences
                </p>
                <Accordion
                ...
                >
                  <AccordionItem
                    itemKey="tween-1"
                    title="Tween Animation Preset"
                  >
                    <p>
                      Soft spring settings (200 stiffness, 20 damping) for
                      gentle, elegant animations.
                    </p>
                  </AccordionItem>
                  <AccordionItem itemKey="tween-2" title="Gentle Touch">
                    <p>
                      Ideal for content-focused applications that need subtle,
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-3">
                  Deliberate timing for accessibility and calm interfaces
                </p>
                <Accordion
                ...
                >
                  <AccordionItem itemKey="slow-1" title="Slow Animation Preset">
                    <p>
                      Slower spring (180 stiffness, 35 damping) creates
                      deliberate, accessible animations.
                    </p>
                  </AccordionItem>
                  <AccordionItem itemKey="slow-2" title="Accessible Design">
                    <p>
                      Perfect for accessibility-focused apps or users who prefer
                      reduced motion.
                    </p>
                  </AccordionItem>
                </Accordion>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    You can also override individual settings while using a
                    preset, or create completely custom configurations.
                  </p>
                </div>
              </div>
            </div>
...
// - slow: Deliberate (180 stiffness, 35 damping, 0.8s)`}
        ...
        <DemoCard title="Enhanced Framer Motion Animations">
          <div className="space-y-6">
            <div>
              <p className="text-sm text-gray-600 mb-4">
                ✨ Now powered by <strong>Framer Motion</strong> for smoother,
                more professional animations including:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4 text-sm text-gray-600 mb-4">
                <li>
                  <strong>Spring-based animations</strong> for natural movement
                </li>
                <li>
                  <strong>Stagger effects</strong> when multiple items render
                </li>
                <li>
                  <strong>Smooth chevron rotations</strong> with
                  micro-interactions
                </li>
                <li>
                  <strong>Content slide & scale effects</strong> for polished
                  feel
                </li>
                <li>
                  <strong>Hover & tap animations</strong> for better user
                  feedback
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mb-3">
                Notice how items animate in sequence when the page loads
              </p>
              <Accordion
                variant="shadow"
                color="primary"
              ...
              >
                <AccordionItem
                  itemKey="stagger-1"
                  title="🚀 First Item - Spring Animation"
                >
                  <div className="space-y-2">
                    <p>
                      This item uses spring-based animations for natural
                      movement.
                    </p>
                    <p className="text-sm text-gray-600">
                      The content slides and scales smoothly when expanding.
                    </p>
                  </div>
                </AccordionItem>
                <AccordionItem
                  itemKey="stagger-2"
                  title="⚡ Second Item - Micro-interactions"
                >
                  <div className="space-y-2">
                    <p>
                      Notice the subtle hover effects on the header and chevron
                      icon.
                    </p>
                    <p className="text-sm text-gray-600">
                      The chevron rotates with a spring animation instead of CSS
                      transitions.
                    </p>
                  </div>
                </AccordionItem>
                <AccordionItem
                  itemKey="stagger-3"
                  title="🎨 Third Item - Smooth Scaling"
                >
                  <div className="space-y-2">
                    <p>Content has enhanced opacity and scaling transitions.</p>
                    <p className="text-sm text-gray-600">
                      Everything feels more responsive and polished.
                    </p>
                  </div>
                </AccordionItem>
                <AccordionItem
                  itemKey="stagger-4"
                  title="💫 Fourth Item - Complete Experience"
                >
                  <div className="space-y-2">
                    <p>
                      The combination of all animations creates a premium user
                      experience.
                    </p>
                    <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                      <p className="text-sm text-blue-800">
                        <strong>Try this:</strong> Hover over headers, click to
                        expand/collapse, and notice the smooth, natural
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700 mt-1">
                      Framer Motion uses hardware acceleration and intelligent
                      batching to ensure smooth 60fps animations even with
                      multiple accordions on the page.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <details>
            ...
            <div className="mt-2">
              <CodeBlock
                code={`// Enhanced with Framer Motion
...
// - Content slide & scale effects`}
        ...
        <DemoCard title="🚀 Performance Test - Multiple Presets">
          <div className="space-y-4">
            <p className="text-gray-600">
              Testing performance with multiple accordions using different
              animation presets simultaneously. All animations should maintain
              60fps even with multiple instances.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="text-xs font-medium text-gray-700 mb-2">
                  Spring + Bouncy Presets
                </p>
                <div className="space-y-2">
                  <Accordion
                    animationConfig={{ preset: "spring" }}
                  ...
                  >
                    <AccordionItem
                      itemKey="perf-spring-1"
                      title="Spring Performance Test"
                    >
                      <p>
                        Testing spring preset performance with smooth 60fps
                        animations.
                      </p>
                    </AccordionItem>
                    <AccordionItem
                      itemKey="perf-spring-2"
                      title="Multiple Items"
                    >
                      <p>
                        Each item should animate independently without frame
                        drops.
                      </p>
                    </AccordionItem>
                  </Accordion>
                  ...
                  >
                    <AccordionItem
                      itemKey="perf-bouncy-1"
                      title="Bouncy Performance Test"
                    >
                      <p>High-energy bouncy animations should remain smooth.</p>
                    </AccordionItem>
                    <AccordionItem
                      itemKey="perf-bouncy-2"
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    <AccordionItem
                      itemKey="perf-smooth-1"
                      title="Smooth Performance Test"
                    >
                      <p>
                        Consistent smooth animations across multiple instances.
                      </p>
                    </AccordionItem>
                    <AccordionItem
                      itemKey="perf-smooth-2"
                      title="Polished Feel"
                    >
                  ...
                  >
                    <AccordionItem
                      itemKey="perf-slow-1"
                      title="Slow Performance Test"
                    >
                      <p>
                        Deliberate timing remains consistent and accessible.
                      </p>
                    </AccordionItem>
                    <AccordionItem
                      itemKey="perf-slow-2"
            ...
            <div className="bg-green-50 p-4 rounded-lg border border-green-200">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-700 mt-1">
                    Framer Motion's optimization ensures all presets maintain
                    smooth 60fps animations, even with multiple accordions and
                    different physics settings on the same page.
                  </p>
                </div>
              </div>
            </div>
        ...
        <DemoCard title="Complete FAQ Example">
          <div className="space-y-4">
            <p className="text-gray-600">
              A real-world example showing a complete FAQ section with multiple
              items and professional styling using the spring preset.
            </p>
            ...
            >
              ...
              <AccordionItem
                itemKey="faq-complete-3"
                title="Is there a free trial available?"
              >
                <p>
                  Yes! We offer a 14-day free trial for all new users. No credit
                  card required. You can explore all features and decide if our
                  platform is right for you.
                </p>
              </AccordionItem>

              <AccordionItem
                itemKey="faq-complete-4"
                title="How can I contact support?"
              >
                <div className="space-y-2">
                  <p>
                    Our support team is available 24/7 through multiple
                    channels:
                  </p>
                  <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <AccordionItem
                itemKey="faq-complete-5"
                title="Can I upgrade or downgrade my plan?"
              >
                <p>
                  Absolutely! You can change your plan at any time from your
                  account settings. Upgrades take effect immediately, while
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border mt-8">
          ...
          <table className="w-full border-collapse">
            ...
            <tbody className="text-sm">
              ...
              <tr className="border-b border-gray-100 dark:border-gray-700">
                ...
                <td className="py-3 px-4 text-gray-700 dark:text-gray-200">
                  Size variant for spacing and padding
                </td>
              </tr>
              <tr className="border-b border-gray-100 dark:border-gray-700">
                <td className="py-3 px-4 font-mono text-purple-600 dark:text-purple-400">
              ...
              <tr className="border-b border-gray-100 dark:border-gray-700">
                ...
                <td className="py-3 px-4 text-gray-700 dark:text-gray-200">
                  Position of expand/collapse indicator
                </td>
              </tr>
              <tr className="border-b border-gray-100 dark:border-gray-700">
                <td className="py-3 px-4 font-mono text-purple-600 dark:text-purple-400">
              ...
              <tr className="border-b border-gray-100 dark:border-gray-700">
                ...
                <td className="py-3 px-4 text-gray-700 dark:text-gray-200">
                  Whether to disable indicator animations
                </td>
              </tr>
              <tr className="border-b border-gray-100 dark:border-gray-700">
                <td className="py-3 px-4 font-mono text-purple-600 dark:text-purple-400">
        ...
        <div className="mt-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            prop accepts the following structure:
          </p>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="text-sm">
                <tr className="border-b border-gray-100 dark:border-gray-700">
                  ...
                  <td className="py-3 px-4 text-gray-600 dark:text-gray-300">
                    'spring' | 'smooth' | 'bouncy' | 'tween' | 'slow'
                  </td>
                  <td className="py-3 px-4 text-gray-500 dark:text-gray-400">
                    'spring'
                  </td>
                  <td className="py-3 px-4 text-gray-700 dark:text-gray-200">
                    Animation preset with predefined settings
                  </td>
                </tr>
                <tr className="border-b border-gray-100 dark:border-gray-700">
                  <td className="py-3 px-4 font-mono text-purple-600 dark:text-purple-400">
                ...
                <tr className="border-b border-gray-100 dark:border-gray-700">
                  ...
                  <td className="py-3 px-4 text-gray-700 dark:text-gray-200">
                    Delay between item animations in seconds
                  </td>
                </tr>
                <tr className="border-b border-gray-100 dark:border-gray-700">
                  <td className="py-3 px-4 font-mono text-purple-600 dark:text-purple-400">
